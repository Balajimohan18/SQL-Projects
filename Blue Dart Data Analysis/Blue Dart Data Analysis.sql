...
--- SHOWCASING EMPLOYEES NAME, EMPLOYEES_ID, QUALIFICATION BY THEIR AGE
SELECT NAME, EMPLOYEEID, AGE, QUALIFICATION FROM EMPLOYEE_DETAILS
...
--- REVENUE BY EACH QUARTER BY EVERY YEAR
SELECT YEAR, 
...
--- 5 HIGH REVENUE GENERATING PRODUCTS
...
--- 5LEAST REVENUE GENERATING PRODUCTS
SELECT TOP 5 OD.PRODUCTID, P.PRODUCTNAME, 
FORMAT(SUM(OD.QUANTITY * P.PRICE), 'C','EN-US') AS TOTAL_REVENUE
FROM ORDER_DETAILS AS OD JOIN PRODUCTS AS P ON OD.PRODUCTID = P.PRODUCTID
GROUP BY OD.PRODUCTID, P.PRODUCTNAME
